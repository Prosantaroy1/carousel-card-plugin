  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
		...
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", cardBody?.title?.typo).googleFontLink}  
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", cardBody?.description?.typo).googleFontLink}  
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", cardBody?.button?.typo).googleFontLink}  

		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(TitleSl, cardBody?.title?.typo).styles}  
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(DescriptionSl, cardBody?.description?.typo).styles}  
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(btnSl, cardBody?.button?.typo).styles}  

		${cardSl}{
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBackgroundCSS)(container?.bg)}
		  height: ${container?.card?.height}
		}

		${TitleSl}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getColorsCSS)(title?.colors)}
		   padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(title?.padding?.[device])};
		}
		${DescriptionSl}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getColorsCSS)(description?.colors)}
		   padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(description?.padding?.[device])};
		}
		${btnSl}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getColorsCSS)(button?.colors)}
		   padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(button?.padding?.[device])};
		}
...
/***/ "./src/Components/Common/Themes/ThemeOne.js":
/*!**************************************************!*\
  !*** ./src/Components/Common/Themes/ThemeOne.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const ThemeOne = ({
  ...
  /* eslint-disable */
  console.log(...oo_oo(`3536559721_8_4_8_44_4`, 'themeOne', column?.desktop));
  const responsive = {
    superLargeDesktop: {
      breakpoint: {
        max: 4000,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "themeOne cardThemeWrapper"
    ...
    }, card.description), card.button && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
      className: "btn"
    }, card.button.text))));
  })));
};
...
document.addEventListener('DOMContentLoaded', () => {
  const blockNameEls = document.querySelectorAll('.wp-block-ccd-carousel-card');
